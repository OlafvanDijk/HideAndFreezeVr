...
public class VR_RoomListing : MonoBehaviour {
    ...
    private void Setup()
    {
        GameObject lobbyCanvasObj = VR_MainCanvasManager.Instance.getLobbyCanvas().gameObject;
        if (lobbyCanvasObj == null)
        {
            return;
        }
        VR_LobbyCanvas lobbyCanvas = lobbyCanvasObj.GetComponent<VR_LobbyCanvas>();
