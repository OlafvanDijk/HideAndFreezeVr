...
public class UI_PlayerLayoutGroup : Photon.PunBehaviour {
    ...
    private List<UI_PlayerListing> playerListings = new List<UI_PlayerListing>();
    public List<UI_PlayerListing> getPlayerListings()
    {
    ...
    {
        foreach(UI_PlayerListing playerListing in playerListings)
        {
    ...
    private void PlayerJoinedRoom(PhotonPlayer photonPlayer)
    {
        ...
        UI_PlayerListing playerListing = playerListingObj.GetComponent<UI_PlayerListing>();
